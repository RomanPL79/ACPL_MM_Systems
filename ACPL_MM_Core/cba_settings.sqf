...
[
    "ACPL_MM_Core_MedicalSupplies_splints", // Internal setting name, should always contain a tag! This will be the global variable which takes the value of the setting.
    "SLIDER", // setting type
    [localize "STR_ACPL_MM_Core_Set_splint", localize "STR_ACPL_MM_Core_Set_Meds_desc"], // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
    [localize "STR_ACPL_MM_Core_Set_Menu", localize "STR_ACPL_MM_Core_Set_Menu_Med_nonmed"], // Pretty name of the category where the setting can be found. Can be stringtable entry.
    [0, 20, 2, 0], // data for this setting: [min, max, default, number of shown trailing decimals]
    true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
    {} // function that will be executed once on mission start and every time the setting is changed.

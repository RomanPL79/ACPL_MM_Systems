...

{
	...
	_return = _return + [[_pos, _class, [_uniform, _u_items_prep, _vest, _v_items_prep, _backpack, _b_items_prep, _headgear, _goggles, _items, _p_weap, _s_weap, _h_weap, _p_items, _s_items, _h_items, _face], [_veh, _veh_data]]];
} foreach _list;

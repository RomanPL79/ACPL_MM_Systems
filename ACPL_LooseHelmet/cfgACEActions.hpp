...
class CAManBase: Man {
	class ACE_SelfActions {
		class ACE_Equipment {
			class ACPL_LooseHelmet_menu {
				...
				class ACPL_LooseHelmet_gun_unfasten: ACPL_LooseHelmet_gun_fasten {
				...
				class ACPL_LooseHelmet_helmet_unfasten: ACPL_LooseHelmet_helmet_fasten {
	...
	class EventHandlers {
		class ACPL_LooseHelmet_HitPart {
